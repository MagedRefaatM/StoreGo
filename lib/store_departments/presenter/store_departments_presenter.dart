...
class StoreDepartmentsPresenter {
  ...
  void fillAdditionalAreasList(
      Datum singleListItem, Function fillListItem, List<Datum> list) {
    if (singleListItem.name != null && singleListItem.order != null) {
  ...
  void handleDeleteListIndex(
      List<Datum> workingOnList,
      List<Datum> additionalList,
  ...
  void handleListElementsRestore(
      List<Datum> deletedItems,
      List<Datum> majorList,
